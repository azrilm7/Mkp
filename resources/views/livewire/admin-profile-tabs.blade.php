									...
									<div class="tab height-100-p">
										<ul class="nav nav-tabs customtab" role="tablist">
											<li class="nav-item">
												...
												data-toggle="tab" href="#personal_details" role="tab">Personal Profile</a>
											</li>
											<li class="nav-item">
										...
										<div class="tab-content">
											...
											<!-- Timeline Tab End -->
											<!-- Tasks Tab start -->
											<div class="tab-pane fade {{ $tab == 'update_password' ? 'active show' : ''}}" id="updates_password" role="tabpanel">
													...
													<div class="row">
														...
														<div class="col-md-4">
															<div class="form-group">
																...
																<input type="password" placeholder="confirm new password" wire:model.defer='new_password_confirmation' class="form-control">
